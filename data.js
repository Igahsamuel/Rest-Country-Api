function toggleFunction() {
  ...
  if (toggleButton) {
    toggleButton.classList.toggle("white-mode");
  }
  const searchButton = document.querySelector(".search");
  if (searchButton) {
    searchButton.classList.toggle("dark-mode");
  }
  const dropdownButton = document.querySelector(".dropdown-option");
  if (dropdownButton) {
    dropdownButton.classList.toggle("dark-mode");
  }
  const backBotton = document.querySelector(".change");
  if (backBotton) {
    backBotton.classList.toggle("dark-mode");
  }
}
toggleFunction();
